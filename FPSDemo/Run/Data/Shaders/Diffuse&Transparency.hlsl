...
//------------------------------------------------------------------------------------------------
Texture2D transparencyTexture : register(t1);

//------------------------------------------------------------------------------------------------
SamplerState transparencySampler : register(s1);
...
float4 PixelMain(v2p_t input) : SV_Target0
{
	...
	float4 transparencyColor = transparencyTexture.Sample(transparencySampler, input.uv);

	float4 color = textureColor * vertexColor * modelColor;

	color.a = 1.f - transparencyColor.r;
